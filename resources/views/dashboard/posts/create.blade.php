...
<div class="col-lg-8">
    <form method="post" action="/dashboard/posts" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="tittle" class="form-control @error('tittle') is-invalid @enderror" id="tittle" autofocus value="{{ old('tittle') }}">
          @error('tittle')
        ...
        <div class="mb-3">
          ...
          <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug" value="{{ old('tittle') }}" required>
          @error('slug')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
